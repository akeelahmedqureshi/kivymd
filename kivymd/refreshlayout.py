...
class MDScrollViewRefreshLayout(ScrollView):
    ...
    def __init__(self, **kargs):
        ...
        super(MDScrollViewRefreshLayout, self).__init__(**kargs)
    ...
    def on_touch_up(self, *args):
        ...
        return super(MDScrollViewRefreshLayout, self).on_touch_up(*args)
...
class RefreshSpinner(ThemableBehavior, FloatLayout):
    ...
    def start_anim_spinner(self):
        ...
        # Animation(y=(spinner.y)/2, d=0.8, t="out_elastic").start(spinner)
